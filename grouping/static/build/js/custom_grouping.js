...
function init_IonRangeSlider() {
    ...
    $(".range_time24").ionRangeSlider({
        min: +moment().subtract(12, "years").format("X"),
        max: +moment().format("X"),
...
//        },
        ...
        ranges: {
            ...
            'Since Start': [moment().subtract(1, 'month').startOf('month'), moment().subtract(1, 'month').endOf('month')]
        },
        opens: 'left',
...
function init_echarts_grouping(candidate_by_country_world_map,max_value,countries,male,female,others) {
    ...
    if ($('#echart_world_map_grouping').length) {

        var echartMap = echarts.init(document.getElementById('echart_world_map_grouping'), theme);
        ...
        echartMap.setOption({
            ...
            series: [{
                ...
                data: candidate_by_country_world_map
            }]
        });

    }

    if ($('#echart_bar_horizontal_grouping').length) {

        var echartBar = echarts.init(document.getElementById('echart_bar_horizontal_grouping'), theme);
    ...
    if ($('#gmat_distribution_gender').length) {

        var echartBar = echarts.init(document.getElementById('gmat_distribution_gender'), theme);
...
debugger;
    ...
    if ($('#canvasDoughnut_grouping').length) {

        var ctx = document.getElementById("canvasDoughnut_grouping");
        var data = {
            labels: label_by_gender
            //     [
            //     "Dark Grey",
            //     "Purple Color",
            //     "Gray Color",
...
$(document).ready(function() {
    ...
    init_echarts_grouping(candidate_by_country_world_map,max_value,countries,male,female,others);
    init_charts_grouping(label_by_gender,value_by_gender)
